...
suso_clear_keys()
credentials<-read_rds(path = "/srv/shiny-server/SuSo_ListingCheck/helpers/surveysolutionsAPI_testcode/credentials.rds")
suso_set_key(credentials$server, credentials$user, credentials$pass)
```
